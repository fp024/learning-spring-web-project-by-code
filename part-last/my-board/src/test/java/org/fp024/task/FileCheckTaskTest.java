...
class FileCheckTaskTest {
  ...
  @Mock private BoardAttachRepository attachRepository;
  ...
  public void beforeEach() throws IOException {
    ...
    task = new FileCheckTask(attachRepository, uploadDirRoot.getAbsolutePath());
  ...
  void testCheckFiles() {
    ...
    when(attachRepository.findByUploadPath(getFolderYesterdayUnixPath())).thenReturn(list);
  ...
  void getOldFiles() {
    ...
    assertThat(task.getOldFiles()).containsAll(list);
  }
